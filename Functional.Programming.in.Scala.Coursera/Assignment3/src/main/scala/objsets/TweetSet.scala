...
class Empty extends TweetSet {
  ...
  def head: Tweet = throw new Exception("Empty tweets have no head.")

  def tail: TweetSet = throw new Exception("Empty tweets have no tail.")

  def descendingByRetweet: TweetList = Nil

  def mostRetweeted: Tweet = throw new NoSuchElementException("Empty tweets can't be sorted.")
}
